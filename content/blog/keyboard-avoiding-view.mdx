...
<div>
    <h3 style={{textAlign: "center", marginTop: 5}}>Android</h3>
  <img width={300} src="/KeyboardAvoidingViewAndroid.gif" alt="KeyboardAvoidingView-Android" />
 </div> 
 <div>
  <h3 style={{textAlign: "center", marginTop: 5}}>IOS</h3>
  <img width={300} src="/KeyboardAvoidingViewIOS.gif" alt="KeyboardAvoidingView-IOS" />
</div>
</div>
